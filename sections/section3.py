                ...
                children=[
                    html.Div(className="section-title",
                            ...
                            html.Div(className="section-full",
                                    children=[
                                        html.Div(className="text-area", children=[
                                            html.P("Mais si le niveau de richesse moyen par habitant ou les dépenses de santé des pays n'expliquent pas la prévalence de l'obésité, d'autre indicateurs culturels, comportementaux et sociétaux parviennent à expliquer, au moins en partie, la tendance à l'augmentation généralisée de la prévalence de l'obésité à travers le monde. Ainsi, l'évolution de l'indice de Gini (mesure standardisée du niveau de partage des richesses au sein d'une population, en l'occurrence au sein de la population de chaque pays ici. Un indice de Gini qui augmente signifie un paratge de la richesse plus inégalitaire, si Gini vaut 0, tout le monde possède autant et si Gini vaut 1, un seul individu possède tout et les autres rien) est corrélée négativement avec l'évolution de la prévalence de l'obésité dans près de 2 pays sur 3. Ce que nous apprend cet indicateur, c'est que la moyennisation de la société (tendance au rapprochement de la richesse de la frange la plus pauvre de la population d'un pays avec les \"classes moyennes\") a pu contribuer au développement de l'obésité dans le monde. En effet, la pauvreté extrême disparaissant au profit d'une augmentation du nombre d'individus aux revenus modestes, de nouveaux comportements de consommation émergent. Cette évolution peut-être mise en parallèle au développement d'une alimentation ultra transformés accessibles à tous ou à la diversification rapide de l'offre de restauration rapide dans une grande partie du monde. Cette évolution dans les habitudes alimentaires est suggérée par la très forte corrélation positive entre variation des apports caloriques quotidiens à travers le monde et prévalence de l'obésité. Depuis 2000, dans plus de 95% des pays du monde, l'apport calorique quotidien à augmenté. Et cette augmentation apparaît comme directement corrélée à l'augmentation de la prévalence de l'obésité dans le monde.", className="body-sec"),

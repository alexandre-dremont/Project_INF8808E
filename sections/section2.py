                            ...
                            html.Div(className="section-full",
                                    children=[
                                        html.Div(className="text-area", children=[
                                            html.P("Au-delà du panorama général de l'obésité aujourd'hui, il est pertinent de se pencher sur l'évolution de la prévalence de l'obésité depuis que cette pathologie est étudiée par la médecine. Des estimations par pays sont disponibles depuis 1980 et mettent en évidence des profils d'évolution contrastés mais une tendance commune. En effet, depuis 1980, la prévalence de l'obésité n'a cessé de croître dans la population mondiale a augmenté de 10% passant de 5% de la population mondiale obèse (i.e. avec un indice de masse corporel dépassant le seuil de 30kg/m²) à 15.3% de la population mondiale en 2024. Dans le détail, aucun pays n'est épargné. Sur ce laps de temps, seule la France a vu le taux d'obésité de sa population diminuer marginalement (de l'ordre de -0.1 point de taux d'obésité dans sa population adulte entre 1980 et 2024). Toutefois, la France comme de nombreux pays industrialisés ne brillent pas dans leur gestion du surpoids qui reste relativement élevé en comparaison de pays moins industrialisés d'Afrique, d'Asie ou d'Amérique Latine.", className="body-sec")
                                        ]),
                            ...
                            html.Div(className="section-full",
                                    children=[
                                        ...
                                        html.Div(className="figure-full",
                                            ...
                                            html.Div(className="text-area", children=[
                                                html.P("Prenons l'exemple particulier des Etats-Unis (United States of America) et de la Chine (China). Les deux pays peuvent aujourd'hui être considérés comme industrialisés, le premier depuis maintenant plusieurs décennies et le second depuis quelques années au moins. On constate alors deux évolutions contrastées. Les USA semblent atteindre un plateau dans l'augmentation de la prévalence de l'obésité, ou au moins un ralentissement notable depuis 2010 environ. En parallèle, la Chine semble compter une part exponentiellement croissante d'obésité au sein de sa population. Les taux de prévalence des deux pays ne sont absolument pas comparables, au même titre que leur culture alimentaire et sportive, leur rapport au surpoids ou leur histoire. Toutefois, le phénomène d'industrialisation de l'alimentation semble directement corrélé à l'augmentation de la prévalence de l'obésité.", className="body-sec")
                                            ]),
                                            html.Div(className="text-area", children=[
                                                html.P("Un autre exemple riche d'enseignements est la comparaison entre l'évolution du taux d'obésité par sexe en Allemagne et au Sénégal. Dans la population adulte générale, l'Allemagne présente un taux d'obésité presque deux fois supérieur à celui du Sénégal mais celui du Sénégal augmente rapidement tandis qu'en Allemagne, l'obésité est stable. Pourtant la prévalence de l'obésité chez les femmes dans ces deux pays est aujourd'hui presque identique, tandis que la prévalence de l'obésité chez les hommes est de l'ordre de quatre fois supérieur en Allemagne par rapport au Sénégal. L'explication de ce phénomène relève davantage de la culture et des standards de beauté régionaux que de facteurs économiques ou d'accès à l'alimentation. L'Allemagne est un pays européen au profil occidental, valorisant la minceur chez les femmes et la carrure large chez les hommes. Au contraire, au Sénégal, il est vu comme un signe de bonne santé que les femmes soient plus corpulentes et que les hommes soient relativement secs et maigres.", className="body-sec")
                                            ]),
                                    ]),
                ]
            )
...
def create_section_2(country_df, ncd_df):
    """Fonction chargée de produire le code HTML de la section II.
    Contient le texte et appelle les figures de la section depuis components"""
    return html.Section(
                id="evolution",
                className="sections",
                children=[
                                    ...
                                    children=[
                                        ...
                                        html.Div(className="figure-full",
                                                 children=[
                                                    ...
                                                    # Vigure n°1 : Distribution de l'IMC par pays au cours du temps
                                    ...
                                    children=[
                                        ...
                                        html.Div(className="figure-full",
                                                 children=[
                                                    ...
                                                    # Evolution temporelle de la prévalence de l'obésité par pays
